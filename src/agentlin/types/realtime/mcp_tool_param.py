...
__all__ = ["McpToolParam", "AllowedTools", "RequireApproval", "RequireApprovalMcpToolApprovalFilter"]

AllowedTools: TypeAlias = Union[SequenceNotStr[str], McpToolFilterParam]
